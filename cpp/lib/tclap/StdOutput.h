...
inline void StdOutput::version(CmdLineInterface& _cmd) 
{
	...
	std::cout << std::endl << progName << "  versión: " 
			  << version << std::endl << std::endl;
}

inline void StdOutput::usage(CmdLineInterface& _cmd ) 
{
	std::cout << std::endl << "Modo de uso: " << std::endl << std::endl; 

	_shortUsage( _cmd, std::cout );

	std::cout << std::endl << std::endl << "Donde: " << std::endl << std::endl;
				                ...
				                ArgException& e ) 
{
	...
	std::cerr << "Error procesando los argumentos: " << e.argId() << std::endl
	...
	if ( _cmd.hasHelpAndVersion() )
	{
		...
		std::cerr << std::endl << "Para el modo de uso detallado: " 
